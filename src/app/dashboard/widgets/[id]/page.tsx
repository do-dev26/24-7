...
export default function WidgetEditPage() {
  ...
  // Fix #7: include router in dependency array
  useEffect(() => {
    widgetAPI.get(id as string)
      .then(setForm)
    ...
    <div className="max-w-2xl">
      ...
      <form onSubmit={save} className="space-y-5">
        <div className="card p-5 space-y-4">
          ...
          <div>
            <label className="lbl">AI Brain</label>
            <select className="inp" value={form.brainType} onChange={e => set('brainType', e.target.value)}>
              {brains.length
                ? brains.map((b: any) => <option key={b.value} value={b.value}>{b.label}</option>)
          ...
          <div>
            ...
            <input className="inp" value={form.welcomeMessage || ''} onChange={e => set('welcomeMessage', e.target.value)} />
          </div>
          <div>
            <label className="lbl">Custom instructions</label>
        ...
        <div className="card p-5 space-y-4">
          <div>
            ...
            <div className="flex gap-2 mt-1">
              ...
              <input type="color" value={form.color || '#10a37f'}
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="text-xs text-gray-400">Widget visible on website</div>
            </div>
